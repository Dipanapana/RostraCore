...
app.include_router(roster_templates.router, prefix=f"{settings.API_V1_PREFIX}/roster-templates", tags=["roster-templates"])
app.include_router(roster_upload.router, prefix=f"{settings.API_V1_PREFIX}/roster-upload", tags=["roster-upload"])
