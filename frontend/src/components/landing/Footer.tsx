...
export default function Footer() {
    return (
        <footer className="relative bg-gray-50 pt-4 pb-12 border-t border-gray-200">
            {/* CTA Section */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><Link href="/register" className="text-gray-600 hover:text-blue-600 transition-colors">Start Trial</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center gap-3 text-gray-600">
                                ...
                                <a href="mailto:support@rostracore.co.za" className="hover:text-gray-900 transition-colors">support@rostracore.co.za</a>
                            </li>
                            <li className="flex items-center gap-3 text-gray-600">
                ...
                <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-gray-500 text-sm">
                        © 2026 RostraCore (Pty) Ltd. All rights reserved.
                    </p>
