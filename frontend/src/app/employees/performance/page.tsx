...
const CASE_TYPE_COLORS: Record<string, string> = {
  ...
  dismissal: 'bg-gray-100 text-gray-700 dark:bg-gray-900/30 dark:text-gray-400',
}
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-4">
          ...
          <div className="text-2xl font-bold text-gray-900 dark:text-white">{data.total_active_employees}</div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-4">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-1"><Award className="w-4 h-4" />Evaluated</div>
          <div className="text-2xl font-bold text-gray-900 dark:text-white">{data.employees_evaluated}</div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-4">
          ...
          <div className="text-2xl font-bold text-gray-900 dark:text-white">{data.total_evaluations}</div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-4">
          <div className="text-sm text-gray-500 mb-1">Avg Score</div>
          <div className="text-2xl font-bold text-gray-900 dark:text-white">{data.avg_overall_score}/5</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
          <h2 className="font-semibold text-gray-900 dark:text-white mb-4">Score Distribution</h2>
            ...
            {[5, 4, 3, 2, 1].map(score => {
              ...
              return (
                <div key={score} className="flex items-center gap-3">
                  <span className="w-20 text-sm text-gray-600 dark:text-gray-400">{SCORE_LABELS[score]}</span>
        ...
        {/* Category Averages */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
          <h2 className="font-semibold text-gray-900 dark:text-white mb-4">Category Averages</h2>
                ...
                avg !== null && (
                  <div key={cat}>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-medium text-gray-900 dark:text-white">{avg}/5</span>
                    </div>
      ...
      {data.top_performers?.length > 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
          <h2 className="font-semibold text-gray-900 dark:text-white mb-4">Top Performers</h2>
          <div className="space-y-2">
            {data.top_performers.map((p: any, i: number) => (
              <div key={p.employee_id} className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700 last:border-0">
                <div className="flex items-center gap-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* By Type */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
          <h2 className="font-semibold text-gray-900 dark:text-white mb-4">Disciplinary by Type</h2>
        ...
        {/* Recent Cases */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
          <h2 className="font-semibold text-gray-900 dark:text-white mb-4">Recent Disciplinary Cases</h2>
