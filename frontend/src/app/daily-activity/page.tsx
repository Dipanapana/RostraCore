...
export default function DailyActivityPage() {
  ...
  const statusBadge = (s: string) => {
    if (s === 'reviewed') return 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400'
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Daily Activity Reports</h1>
      ...
      {tab === 'reports' && (
        <div className="space-y-4">
          <div className="flex gap-3 items-center flex-wrap">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">{total} reports (last 30 days)</span>
          </div>
          ...
          <div className="space-y-3">
            {reports.length === 0 ? (
              ...
              reports.map((r) => (
                <div key={r.report_id} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-900 dark:text-white">{r.summary}</p>
      ...
      {tab === 'dashboard' && dashboard && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Daily Trend */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Daily Trend (Last 7 Days)</h3>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
              <h3 className="font-semibold text-gray-900 dark:text-white">New Daily Activity Report</h3>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Patrols Completed</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Incidents Reported</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Visitors Processed</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Access Denied</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Notable Events</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Equipment Issues</label>
      ...
      {showReview && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md">
            <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
              <h3 className="font-semibold text-gray-900 dark:text-white">Review Report</h3>
              <button onClick={() => setShowReview(null)} className="text-gray-400 hover:text-gray-600"><X className="w-5 h-5" /></button>
            </div>
            <div className="p-4 space-y-4">
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                <p className="text-sm text-gray-900 dark:text-white">{showReview.summary}</p>
                {showReview.site_name && (
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Site: {showReview.site_name}</p>
                )}
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Date: {formatDate(showReview.report_date)}</p>
              </div>
              <div>
            ...
            <div className="flex justify-end gap-2 p-4 border-t border-gray-200 dark:border-gray-700">
              <button onClick={() => setShowReview(null)} className="px-4 py-2 text-sm text-gray-600 dark:text-gray-400">Cancel</button>
