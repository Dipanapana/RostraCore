    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-4">
          ...
          <div className="text-lg font-bold text-gray-900 dark:text-white">{formatCurrency(data.total_invoiced)}</div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-4">
          ...
          <div className="text-lg font-bold text-gray-900 dark:text-white">{formatCurrency(data.annual_contract_value)}</div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
        <div className="flex items-center justify-between mb-2">
          <h2 className="font-semibold text-gray-900 dark:text-white">Collection Rate</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {data.by_client.length > 0 && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
            <h2 className="font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2"><Building2 className="w-4 h-4" />Revenue by Client</h2>
                ...
                <tbody>
                  {data.by_month.map((m: any) => (
                    <tr key={m.month} className="border-b border-gray-100 dark:border-gray-700 last:border-0">
                      ...
                      <td className="py-2 text-right text-gray-700 dark:text-gray-300">{formatCurrency(m.invoiced)}</td>
