      ...
      <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="flex flex-wrap gap-4 items-end">
            <div>
              ...
              <input
                ...
                className="text-sm border border-slate-200 dark:border-slate-600 rounded-lg px-3 py-2 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-400"
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">
            ...
            <div>
              ...
              <input
                ...
                min={0}
                className="text-sm border border-slate-200 dark:border-slate-600 rounded-lg px-3 py-2 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-400 w-36"
              />
            </div>
            <button
              onClick={handleRun}
        ...
        {forecast && s && (
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                },
                {
                  ...
                  bg: s.fill_rate_pct >= 90 ? 'bg-emerald-50 dark:bg-emerald-900/20' : s.fill_rate_pct >= 70 ? 'bg-amber-50 dark:bg-amber-900/20' : 'bg-red-50 dark:bg-red-900/20',
                },
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-4 shadow-sm flex items-center gap-6">
              ...
              <div>
                <p className="text-sm font-medium text-slate-700 dark:text-slate-300">
                  ...
                  <span className={s.projected_profit >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'}>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/30">
                        {['Site', 'Client', 'Shifts', 'Fill %', 'Hours', 'Wage Cost', 'Revenue', 'Margin'].map((h) => (
                          <th
                            key={h}
                            className="px-4 py-2.5 text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide whitespace-nowrap"
                          >
                            {h}
                          </th>
                        ))}
                      ...
                      {forecast.sites.map((site) => (
                        <tr key={site.site_id} className="hover:bg-slate-50 dark:hover:bg-slate-700/20 transition-colors">
                          ...
                          <td className="px-4 py-3 whitespace-nowrap">
                            <span className="text-slate-800 dark:text-slate-200">{site.filled_shifts}</span>
                            <span className="text-slate-400">/{site.total_shifts}</span>
                    ...
                    {/* Totals row */}
                    <tfoot>
                      <tr className="bg-slate-50 dark:bg-slate-900/30 border-t-2 border-slate-200 dark:border-slate-700 font-semibold">
                        <td className="px-4 py-3 text-slate-800 dark:text-slate-200" colSpan={2}>
                          Total
                        </td>
